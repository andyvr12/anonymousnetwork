...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { numberVotes: @score.numberVotes, publication_id: @score.publication_id, total: @score.total }
    end
  ...
  test "should update score" do
    put :update, id: @score, score: { numberVotes: @score.numberVotes, publication_id: @score.publication_id, total: @score.total }
    assert_redirected_to score_path(assigns(:score))
  end
